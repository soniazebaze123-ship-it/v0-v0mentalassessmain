...
const englishTranslations: TranslationMap = {
  ...
  "moca.naming.instruction": "Look at each image and tap the correct animal name.",
...
const zhOverrides: TranslationMap = {
  ...
  "moca.naming": "动物命名",
  "moca.naming.instruction": "请看每一张图片，并点击正确的动物名称。",
  "moca.memory": "记忆任务",
...
const yueOverrides: TranslationMap = {
  ...
  "moca.naming": "動物命名",
  "moca.naming.instruction": "請睇每一張圖片，按正確嘅動物名稱。",
  "moca.memory": "記憶任務",
...
const frOverrides: TranslationMap = {
  ...
  "moca.naming.instruction": "Regardez chaque image et touchez le bon nom de l'animal.",
